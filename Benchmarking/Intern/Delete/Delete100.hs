...
e100 = deleteAVL (mkNode (Proxy::Proxy 99) 'a') $ deleteAVL (mkNode (Proxy::Proxy 98) 'a') $ deleteAVL (mkNode (Proxy::Proxy 97) 'a') $ deleteAVL (mkNode (Proxy::Proxy 96) 'a') $ deleteAVL (mkNode (Proxy::Proxy 95) 'a') $ deleteAVL (mkNode (Proxy::Proxy 94) 'a') $ deleteAVL (mkNode (Proxy::Proxy 93) 'a') $ deleteAVL (mkNode (Proxy::Proxy 92) 'a') $ deleteAVL (mkNode (Proxy::Proxy 91) 'a') $ deleteAVL (mkNode (Proxy::Proxy 90) 'a') $
  deleteAVL (mkNode (Proxy::Proxy 89) 'a') $ deleteAVL (mkNode (Proxy::Proxy 88) 'a') $ deleteAVL (mkNode (Proxy::Proxy 87) 'a') $ deleteAVL (mkNode (Proxy::Proxy 86) 'a') $ deleteAVL (mkNode (Proxy::Proxy 85) 'a') $ deleteAVL (mkNode (Proxy::Proxy 84) 'a') $ deleteAVL (mkNode (Proxy::Proxy 83) 'a') $ deleteAVL (mkNode (Proxy::Proxy 82) 'a') $ deleteAVL (mkNode (Proxy::Proxy 81) 'a') $ deleteAVL (mkNode (Proxy::Proxy 80) 'a') $
