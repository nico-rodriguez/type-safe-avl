...
module Benchmarking.Intern.Insert.Insert50 (t50, main) where
...
t50 = insertAVL (mkNode (Proxy::Proxy 49) 'a') $ insertAVL (mkNode (Proxy::Proxy 48) 'a') $ insertAVL (mkNode (Proxy::Proxy 47) 'a') $ insertAVL (mkNode (Proxy::Proxy 46) 'a') $ insertAVL (mkNode (Proxy::Proxy 45) 'a') $ insertAVL (mkNode (Proxy::Proxy 44) 'a') $ insertAVL (mkNode (Proxy::Proxy 43) 'a') $ insertAVL (mkNode (Proxy::Proxy 42) 'a') $ insertAVL (mkNode (Proxy::Proxy 41) 'a') $ insertAVL (mkNode (Proxy::Proxy 40) 'a') $
