...
module Benchmarking.Extern.Insert.Insert80 (t80, main) where
...
t80 = insertAVL (mkNode (Proxy::Proxy 79) 'a') $ insertAVL (mkNode (Proxy::Proxy 78) 'a') $ insertAVL (mkNode (Proxy::Proxy 77) 'a') $ insertAVL (mkNode (Proxy::Proxy 76) 'a') $ insertAVL (mkNode (Proxy::Proxy 75) 'a') $ insertAVL (mkNode (Proxy::Proxy 74) 'a') $ insertAVL (mkNode (Proxy::Proxy 73) 'a') $ insertAVL (mkNode (Proxy::Proxy 72) 'a') $ insertAVL (mkNode (Proxy::Proxy 71) 'a') $ insertAVL (mkNode (Proxy::Proxy 70) 'a') $
