...
module Benchmarking.Extern.Insert.Insert70 (t70, main) where
...
t70 = insertAVL (mkNode (Proxy::Proxy 69) 'a') $ insertAVL (mkNode (Proxy::Proxy 68) 'a') $ insertAVL (mkNode (Proxy::Proxy 67) 'a') $ insertAVL (mkNode (Proxy::Proxy 66) 'a') $ insertAVL (mkNode (Proxy::Proxy 65) 'a') $ insertAVL (mkNode (Proxy::Proxy 64) 'a') $ insertAVL (mkNode (Proxy::Proxy 63) 'a') $ insertAVL (mkNode (Proxy::Proxy 62) 'a') $ insertAVL (mkNode (Proxy::Proxy 61) 'a') $ insertAVL (mkNode (Proxy::Proxy 60) 'a') $
