...
module Benchmarking.Extern.Insert.Insert100 (t100, main) where
...
t100 = insertAVL (mkNode (Proxy::Proxy 99) 'a') $ insertAVL (mkNode (Proxy::Proxy 98) 'a') $ insertAVL (mkNode (Proxy::Proxy 97) 'a') $ insertAVL (mkNode (Proxy::Proxy 96) 'a') $ insertAVL (mkNode (Proxy::Proxy 95) 'a') $ insertAVL (mkNode (Proxy::Proxy 94) 'a') $ insertAVL (mkNode (Proxy::Proxy 93) 'a') $ insertAVL (mkNode (Proxy::Proxy 92) 'a') $ insertAVL (mkNode (Proxy::Proxy 91) 'a') $ insertAVL (mkNode (Proxy::Proxy 90) 'a') $
  insertAVL (mkNode (Proxy::Proxy 89) 'a') $ insertAVL (mkNode (Proxy::Proxy 88) 'a') $ insertAVL (mkNode (Proxy::Proxy 87) 'a') $ insertAVL (mkNode (Proxy::Proxy 86) 'a') $ insertAVL (mkNode (Proxy::Proxy 85) 'a') $ insertAVL (mkNode (Proxy::Proxy 84) 'a') $ insertAVL (mkNode (Proxy::Proxy 83) 'a') $ insertAVL (mkNode (Proxy::Proxy 82) 'a') $ insertAVL (mkNode (Proxy::Proxy 81) 'a') $ insertAVL (mkNode (Proxy::Proxy 80) 'a') $
