...
t25 = insertN (Proxy::Proxy 100) (Proxy::Proxy 'False) (AVL EmptyITree)
t50 :: AVL (InsertN 200 'False 'EmptyTree)
t50 = insertN (Proxy::Proxy 200) (Proxy::Proxy 'False) (AVL EmptyITree)
t75 :: AVL (InsertN 300 'False 'EmptyTree)
t75 = insertN (Proxy::Proxy 300) (Proxy::Proxy 'False) (AVL EmptyITree)
t25 :: AVL (InsertN 400 'False 'EmptyTree)
t25 = insertN (Proxy::Proxy 400) (Proxy::Proxy 'False) (AVL EmptyITree)
e1 :: AVL 'EmptyTree
