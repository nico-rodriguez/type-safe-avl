...
t1000 = insertN (Proxy::Proxy 1000) (Proxy::Proxy 'False) (AVL EmptyITree)
t1500 :: AVL (InsertN 1500 'False 'EmptyTree)
t1500 = insertN (Proxy::Proxy 1500) (Proxy::Proxy 'False) (AVL EmptyITree)
t2000 :: AVL (InsertN 2000 'False 'EmptyTree)
t2000 = insertN (Proxy::Proxy 2000) (Proxy::Proxy 'False) (AVL EmptyITree)
e1 :: AVL 'EmptyTree
