...
module Benchmarking.FullExtern.Insert.Insert80 (t80, main) where
...
t80 = gcastWith (proofIsAVL t) $ gcastWith (proofIsBST t) $ AVL t
  where
    t = insert (mkNode (Proxy::Proxy 79) 'a') $ insert (mkNode (Proxy::Proxy 78) 'a') $ insert (mkNode (Proxy::Proxy 77) 'a') $ insert (mkNode (Proxy::Proxy 76) 'a') $ insert (mkNode (Proxy::Proxy 75) 'a') $ insert (mkNode (Proxy::Proxy 74) 'a') $ insert (mkNode (Proxy::Proxy 73) 'a') $ insert (mkNode (Proxy::Proxy 72) 'a') $ insert (mkNode (Proxy::Proxy 71) 'a') $ insert (mkNode (Proxy::Proxy 70) 'a') $
