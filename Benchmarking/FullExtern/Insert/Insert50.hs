...
module Benchmarking.FullExtern.Insert.Insert50 (t50, main) where
...
t50 = gcastWith (proofIsAVL t) $ gcastWith (proofIsBST t) $ AVL t
  where
    t =  insert (mkNode (Proxy::Proxy 49) 'a') $ insert (mkNode (Proxy::Proxy 48) 'a') $ insert (mkNode (Proxy::Proxy 47) 'a') $ insert (mkNode (Proxy::Proxy 46) 'a') $ insert (mkNode (Proxy::Proxy 45) 'a') $ insert (mkNode (Proxy::Proxy 44) 'a') $ insert (mkNode (Proxy::Proxy 43) 'a') $ insert (mkNode (Proxy::Proxy 42) 'a') $ insert (mkNode (Proxy::Proxy 41) 'a') $ insert (mkNode (Proxy::Proxy 40) 'a') $
