...
module Benchmarking.FullExtern.Insert.Insert70 (t70, main) where
...
t70 = gcastWith (proofIsAVL t) $ gcastWith (proofIsBST t) $ AVL t
  where
    t =  insert (mkNode (Proxy::Proxy 69) 'a') $ insert (mkNode (Proxy::Proxy 68) 'a') $ insert (mkNode (Proxy::Proxy 67) 'a') $ insert (mkNode (Proxy::Proxy 66) 'a') $ insert (mkNode (Proxy::Proxy 65) 'a') $ insert (mkNode (Proxy::Proxy 64) 'a') $ insert (mkNode (Proxy::Proxy 63) 'a') $ insert (mkNode (Proxy::Proxy 62) 'a') $ insert (mkNode (Proxy::Proxy 61) 'a') $ insert (mkNode (Proxy::Proxy 60) 'a') $
