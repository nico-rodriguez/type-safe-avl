...
module Benchmarking.FullExtern.Insert.Insert100 (t100, main) where
...
t100 = gcastWith (proofIsAVL t) $ gcastWith (proofIsBST t) $ AVL t
  where
    t =  insert (mkNode (Proxy::Proxy 99) 'a') $ insert (mkNode (Proxy::Proxy 98) 'a') $ insert (mkNode (Proxy::Proxy 97) 'a') $ insert (mkNode (Proxy::Proxy 96) 'a') $ insert (mkNode (Proxy::Proxy 95) 'a') $ insert (mkNode (Proxy::Proxy 94) 'a') $ insert (mkNode (Proxy::Proxy 93) 'a') $ insert (mkNode (Proxy::Proxy 92) 'a') $ insert (mkNode (Proxy::Proxy 91) 'a') $ insert (mkNode (Proxy::Proxy 90) 'a') $
      insert (mkNode (Proxy::Proxy 89) 'a') $ insert (mkNode (Proxy::Proxy 88) 'a') $ insert (mkNode (Proxy::Proxy 87) 'a') $ insert (mkNode (Proxy::Proxy 86) 'a') $ insert (mkNode (Proxy::Proxy 85) 'a') $ insert (mkNode (Proxy::Proxy 84) 'a') $ insert (mkNode (Proxy::Proxy 83) 'a') $ insert (mkNode (Proxy::Proxy 82) 'a') $ insert (mkNode (Proxy::Proxy 81) 'a') $ insert (mkNode (Proxy::Proxy 80) 'a') $
