...
module AVL.Intern.Example.Example50 (t50, main) where
...
t50 = insertAVL (Proxy::Proxy 49) 'a' $ insertAVL (Proxy::Proxy 48) 'a' $ insertAVL (Proxy::Proxy 47) 'a' $ insertAVL (Proxy::Proxy 46) 'a' $ insertAVL (Proxy::Proxy 45) 'a' $ insertAVL (Proxy::Proxy 44) 'a' $ insertAVL (Proxy::Proxy 43) 'a' $ insertAVL (Proxy::Proxy 42) 'a' $ insertAVL (Proxy::Proxy 41) 'a' $ insertAVL (Proxy::Proxy 40) 'a' $
