...
main =
    do
        ...
        print t1'
        t1 <- getCurrentTime
        putStrLn $ "N=10^1: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t2'
        t1 <- getCurrentTime
        putStrLn $ "N=10^2: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t3'
        t1 <- getCurrentTime
        putStrLn $ "N=10^3: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t4'
        t1 <- getCurrentTime
        putStrLn $ "N=10^4: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t5'
        t1 <- getCurrentTime
        putStrLn $ "N=10^5: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t6'
        t1 <- getCurrentTime
