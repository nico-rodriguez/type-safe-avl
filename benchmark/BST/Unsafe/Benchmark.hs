...
main =
    do
        ...
        print t1'
        t1 <- getCurrentTime
        putStrLn $ "N=5^1: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t2'
        t1 <- getCurrentTime
        putStrLn $ "N=5^2: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t3'
        t1 <- getCurrentTime
        putStrLn $ "N=5^3: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t4'
        t1 <- getCurrentTime
        putStrLn $ "N=5^4: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t5'
        t1 <- getCurrentTime
        putStrLn $ "N=5^5: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t6'
        t1 <- getCurrentTime
        putStrLn $ "N=5^6: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t7'
        t1 <- getCurrentTime
        putStrLn $ "N=5^7: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t8'
        t1 <- getCurrentTime
        putStrLn $ "N=5^8: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t9'
        t1 <- getCurrentTime
        putStrLn $ "N=5^9: " ++ show (diffUTCTime t1 t0)
        t0 <- getCurrentTime
        print t10'
        t1 <- getCurrentTime
        putStrLn $ "N=5^10: " ++ show (diffUTCTime t1 t0)
        -- Delete
        putStrLn "DELETE"
        t0 <- getCurrentTime
        print e1
