...
instance (o ~ CmpNat x n,
  ...
  proofIsBSTInsert node (BST _ tIsBST) = proofIsBSTInsert' node tIsBST (Proxy::Proxy o)
...
instance (CmpNat x n ~ 'LT) =>
  ...
  proofIsBSTInsert' node (ForkIsBSTT _ node' r) _ =
...
instance (l ~ 'ForkTree ll (Node ln lna) lr, o ~ CmpNat x ln,
  ...
  proofIsBSTInsert' node (ForkIsBSTT l node' r) _ =
...
instance (CmpNat x n ~ 'GT) =>
  ...
  proofIsBSTInsert' node (ForkIsBSTT l node' _) _ =
...
instance (l ~ 'ForkTree ll (Node ln lna) lr, o ~ CmpNat x ln,
  ...
  proofLtNInsert' node (ForkIsBSTT l _ _) pn _ =
...
instance (r ~ 'ForkTree rl (Node rn rna) rr, o ~ CmpNat x rn,
  ...
  proofLtNInsert' node (ForkIsBSTT _ _ r) pn _ =
...
instance (l ~ 'ForkTree ll (Node ln lna) lr, o ~ CmpNat x ln,
  ...
  proofGtNInsert' x (ForkIsBSTT l _ _) pn _ =
...
instance (r ~ 'ForkTree rl (Node rn rna) rr, o ~ CmpNat x rn,
  ...
  proofGtNInsert' x (ForkIsBSTT _ _ r) pn _ =
